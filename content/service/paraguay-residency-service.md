...
itinerary:
  - title: "Phase 1: Pre-Arrival (Document Prep)"
    body: |
      Crucial Step.
  ...
  - title: "Phase 2: The Application Days"
    body: |
  ...
  - title: "Phase 3: Processing & Approval"
    body: You can return home while the government processes your file. We track the status weekly. Once approved, we pick up your Residency Card.
  - title: "Phase 4: The ID (Cédula)"
    body: |
  ...
  - title: Digital Nomads
    body: Looking for a tax-friendly base with a low cost of living.
  - title: Investors
    body: Looking to buy land or open a company (Residency simplifies doing business).
  - title: Retirees
    body: Looking for a peaceful, affordable country with warm weather year-round.
why: []
practical:
  - label: Residency Type
    value: Most applicants start with Temporary Residency (2 Years), which is renewable or convertible to Permanent Residency later.
  - label: Requirements
    value: Clean criminal record, valid passport, and proof of solvency (we explain the options).
  - label: Timeframe
    value: Total processing time varies (usually 3-6 months from filing to ID), but you only need to be in Paraguay for a few days to file.
faq:
