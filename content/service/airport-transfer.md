...
itinerary:
  ...
  - title: Executive SUV
    body: Ideal for business travelers or extra legroom. (Toyota Fortuner / Kia Sorento)
  - title: Family Van
    body: Ideal for families or groups with heavy luggage. (Hyundai H1 / Kia Carnival)
why:
  - title: Fixed Pricing
    body: Safety First
...
practical:
  - label: Airport Code
    value: ASU (Silvio Pettirossi International Airport).
  - label: Location
    value: Luque (approx. 20-30 mins from Asunción center).
  - label: Waiting Time
    value: We include 60 minutes of free waiting time after your flight lands to allow for customs/immigration.
faq:
