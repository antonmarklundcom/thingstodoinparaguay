...
itinerary:
  - title: The Golden Dorado (El Tigre)
    body: The prize trophy. Known for its brilliant gold scales and ferocious temper. Pound for pound, it is one of the hardest fighting fish in the world. Catching one is a badge of honor.
  - title: The Surubí (The Giant)
    body: The king of the bottom. These spotted catfish grow to massive sizes. Hooking one feels like you are pulling up a sunken car. They are powerful, stubborn, and distinctively beautiful with their leopard-print skin.
  - title: Pacú & Boga (The Table Fare)
    body: Pound for pound, the Pacú (river pig) offers an incredible fight and is delicious to eat. We often stop on a sandy island to cook your fresh catch over an open fire for lunch.
why:
  - title: Pro Guides
    body: Our captains are locals who have fished these waters since childhood. They know where the schools are moving based on the water level and temperature. They don't just drive; they teach you how to hook the big ones.
  - title: Safety First
    body: The Paraná is a powerful commercial waterway. Our boats are equipped with life vests, radios, and reliable motors. We prioritize your safety so you can focus on the rod tip.
  - title: All-Inclusive Gear
    body: We supply the rods, reels, lures, and live bait. If you are a fly-fisherman, we can guide you to the shallow rapids, though we recommend bringing your specialized flies.
practical:
  - label: ""
    value: Duration:
  - label: Full Day
    value: 8-10 Hours on the water.
  - label: Expedition
    value: 2-3 Days (Sleeping in Fishing Lodges).
  - label: Location
    value: We drive to Ayolas (approx. 4 hours from Asunción) or Paso de Patria.
  - label: ""
    value: Best Season:
  - label: Dorado
    value: September to April (Warmer months).
  - label: ""
    value: "Surubí: Active year-round, but better in cooler transitions."
  - label: Fishing License
    value: Included/Arranged by us.
faq:
