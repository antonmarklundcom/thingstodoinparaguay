...
<section class="tour-cta" aria-labelledby="hub-cta">
    <div class="container">
        <h2 id="hub-cta">Want help putting a route together?</h2>
        <p>
            <a class="button button--primary" href="/contact/">Send us your dates</a> and we will tell you what fits — and what is worth skipping.
        </p>
    </div>
</section>
