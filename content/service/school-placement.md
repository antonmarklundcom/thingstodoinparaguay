...
itinerary:
  ...
  - title: The Shortlist & Visits
    body: We curate a list of the top contenders (e.g., ASA, Pan American, Goethe, San Andrés, SIL, Lumière, etc.). We schedule the interviews and campus tours, accompanying you to translate and ask the technical questions about accreditation and university placements.
  - title: Admission Assistance
    body: Paperwork in Paraguay can be heavy. We guide you through the requirements—legalized transcripts, vaccination records, and birth certificates—ensuring your application file is perfect to maximize acceptance chances.
why:
  - title: Unbiased Advice
    body: We are not affiliated with any specific school. Our loyalty is to your family. If a school has a reputation for bullying or declining academic standards, we will tell you honestly.
  - title: Language Support
    body: Admissions directors often speak English, but the administrative staff might not. We handle the emails and calls to ensure nothing gets lost in translation.
  - title: Integration Tips
    body: We don't just stop at enrollment. We advise you on the social side—where to buy uniforms, how the school bus system works, and how to connect with other expat parents.
practical:
  - label: Top International Schools
    value: ASA (American), Pan American (International), Goethe (German), Jules Verne (French), San Andrés (British style).
  - label: Tuition Range
    value: From $300 USD to $1,500+ USD per month depending on the prestige.
  - label: ""
    value: Calendars:
  - label: ""
    value: "International (ASA): August to June."
  - label: Local/Bilingual
    value: February to November.
  - label: Service Scope
    value: Asunción and Greater Asunción.
faq:
