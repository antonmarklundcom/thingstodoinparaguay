...
itinerary:
  - title: Expat Health Concierge
    body: For residents. We help you set up your local health insurance (Seguro Privado), find a primary care physician, and navigate routine checkups. We act as your emergency contact if you need an ambulance or hospitalization.
  - title: Dental Tourism (The "Hollywood Smile")
    body: Paraguay is a hidden gem for dentistry. Implants, veneers, and orthodontics cost 60-70% less than in the US or Europe, using the exact same German or American materials. We arrange your "Dental Vacation," coordinating appointments with top implantologists.
  - title: Specialized Treatments
    body: From cosmetic surgery to fertility treatments, we connect you with board-certified surgeons in Paraguay's most advanced private clinics.
why:
  - title: Access to the "Top Tier"
    body: We only work with the "A-List" private hospitals (like Sanatorio Migone, La Costa, Santa Julia) and clinics. We do not refer to public hospitals. We ensure the facility meets international hygiene and technology standards.
  - title: Language Support
    body: Many of our partner doctors speak English. If a specific specialist does not, we provide a medical translator to accompany you, ensuring no symptom is lost in translation.
  - title: Transparent Pricing
    body: Medical billing can be opaque. We give you price estimates upfront for consultations and procedures, so there are no surprise bills at checkout.
practical:
  - label: Quality
    value: Private care in Asunción is comparable to Brazil or Argentina.
  - label: Cost Savings
    value: Approx. 50-70% cheaper than US prices for procedures.
  - label: Insurance
    value: We help verify if your Cigna/Bupa/Allianz works here, or help you buy local coverage (Santa Clara, Asismed, etc.).
  - label: Location
    value: Most top clinics are in the new corporate center or near Avenida España.
faq:
